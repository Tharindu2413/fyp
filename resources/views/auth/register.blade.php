<x-guest-layout>
    <x-auth-card>
        <x-slot name="logo">
            ...
            <h1 class="text-4xl subpixel-antialiased font-semibold">Lifestream.net</h1>
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Name -->
            <div class="mt-4">
                <x-label for="owneruser" :value="__('Are you registering as Hospital')" />

                <x-input id="owneruser" class="block w-5 h-5 mt-1 text-orange-600 form-checkbox" type="checkbox" name="owneruser" autofocus />
            </div>
